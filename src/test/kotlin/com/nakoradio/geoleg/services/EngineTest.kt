...
internal class EngineTest {
    ...
    @Nested
    inner class `Success scenarios for an empty state` {
         ...
         */
        @Test
        fun `scanning the first on field QR should restart the scneario` () {
     ...
     */
    @Nested
    inner class `Failure scenarios for an empty state` {
